    ...
    <div class="section">
        <div class="container">
            ...
            <div class="product-grid">
                ...
                <a href="{{ route('product.detail', 'muzan-t-shirt') }}" class="product-card">
                ...
                <a href="{{ route('product.detail', 'douma-t-shirt') }}" class="product-card">
                    <div class="product-image">
                ...
                <!-- Product 3 - MT-Shirt -->
                <a href="{{ route('product.detail', 'mt-shirt') }}" class="product-card">
                    <div class="product-image">
                ...
                <a href="{{ route('product.detail', 'cosmos-tshirt') }}" class="product-card">
                    <div class="product-image">
                    ...
                    <div class="product-info">
                        <div class="product-content">
                            <div class="product-details">
                                ...
                                <p class="product-price">IDR {{ number_format($product->harga_jual ?? $product->harga, 0, ',', '.') }}</p>
                            </div>
                            <div class="product-arrow">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M5 12h14m-7-7 7 7-7 7" />
